...
install_skill() {
    echo ""
    log_info "Installing Goals & KPIs Skill..."
    echo "================================================"
    echo ""
    ...
    if [ "$ALL_FILES_EXIST" = true ]; then
        ...
        echo "2. Use the skill with: /goals-and-kpis"
        ...
        echo "   • Set Q2 OKRs for my 30-person B2B SaaS startup"
        echo "   • Design a KPI dashboard for our marketing team"
        echo "   • Cascade our \$10M ARR goal into team objectives"
        echo "   • Run a goal-setting workshop for leadership"
        echo ""
    else
